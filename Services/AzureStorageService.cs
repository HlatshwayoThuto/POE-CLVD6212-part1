...
namespace ABCRetailers1.Services
{
    public class AzureStorageService : IAzureStorageService
    {
        ...
        private async Task InitializeStorageAsync()
        {
            try
            {
                ...
                await contractsShare.GetDirectoryClient("payments").CreateIfNotExistsAsync();
        ...
        public async Task<T> GetEntityAsync<T>(string partitionKey, string rowKey) where T : class, ITableEntity, new()
        {
            ...
            {
                return null!; // interface doesn’t allow nullable
            }
        }
        ...
        public async Task UploadToFileShareAsync(IFormFile file, string shareName, string directoryName = "")
        {
