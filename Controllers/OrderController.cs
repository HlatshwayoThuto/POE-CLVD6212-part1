using ABCRetailers1.Models.ViewModels;
using ABCRetailers1.Models;
using Microsoft.AspNetCore.Mvc;
using System.Text.Json;
using ABCRetailers1.Services;

namespace ABCRetailers1.Controllers
{
                ...
                try
                {
                    ...
                    var order = new Order
                    {
                        ...
                        Status = "Submitted", // Always starts as Submitted
                         OrderDate = DateTime.SpecifyKind(DateTime.UtcNow, DateTimeKind.Utc) // ✅ Force UTC
                    };
                    ...
                    var orderMessage = new
                    {
                        ...
                        CustomerName = customer.Username + " " + customer.Surname,
                        ProductName = product.ProductName,
